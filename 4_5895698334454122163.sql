...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 29, 2019 at 02:48 PM
...
CREATE TABLE `motarjem_register` (
  ...
  `password` varchar(11) COLLATE utf8_persian_ci NOT NULL,
...
CREATE TABLE `order_tarjome` (
  ...
  `motarjem` varchar(50) COLLATE utf8_persian_ci NOT NULL,
  `get` varchar(11) COLLATE utf8_persian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_persian_ci;
...
INSERT INTO `order_tarjome` (`id`, `username`, `tell`, `email`, `cat_tarjomeh`, `file`, `ezafi`, `price`, `motarjem`, `get`) VALUES
(7, 'a', 542, 'bbbbbb@l.com', 2, 'img/kashadn_db.sql', 11152, 200000, '', '1'),
(8, 'b', 5454, 'faramarz.code@yahoo.com', 2, 'img/kashan_db.sql', 14554, 200000, '', '1'),
(9, 'oooooo', 8754, 'b@l.com', 1, 'img/kashan_db.sql', 3796, 350000, '', '1');
